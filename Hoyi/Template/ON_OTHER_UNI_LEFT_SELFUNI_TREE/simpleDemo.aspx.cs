...
{
    public partial class lstrpg_<%%# e.ClassName  #%%> : ValidatedPage
    {        
        ...
        #region <%%# e.unself_out_tb().ClassName #%%>树控件

        public List<<%%# e.unself_out_tb().ClassName #%%>Info> getBy<%%# e.unself_out_tb().ClassName.ToParscal() #%%><%%# e.unself_out_tb().self_uni_in_name().ToParscal() #%%>(string <%%# e.unself_out_tb().self_uni_in_name() #%%>)
        {
            int recordCount = <%%# e.unself_out_tb().ClassName #%%>Factory.Create().GetBy<%%# e.unself_out_tb().self_uni_in_name().ToParscal() #%%>Count(<%%# e.unself_out_tb().self_uni_in_name() #%%>);
            IPagingDataInfo pgInfo = new IPagingDataInfo(<%%# e.unself_out_tb().ClassName #%%>Info.F_<%%# e.unself_out_tb().getfirfieldname() #%%>, recordCount.ToString(), "1");
            return <%%# e.unself_out_tb().ClassName #%%>Info.TransDataTable(<%%# e.unself_out_tb().ClassName #%%>Factory.Create().GetBy<%%# e.unself_out_tb().self_uni_in_name().ToParscal() #%%>(pgInfo, <%%# e.unself_out_tb().self_uni_in_name() #%%>));
        }

        public void AddTrees(TreeNode parentNode, List<<%%# e.unself_out_tb().ClassName #%%>Info> <%%# e.unself_out_tb().ClassName #%%>s)
        {
            TreeNode tmpNode;

            foreach (<%%# e.unself_out_tb().ClassName #%%>Info <%%# e.unself_out_tb().ClassName #%%> in <%%# e.unself_out_tb().ClassName #%%>s)
            {
                tmpNode = new TreeNode(<%%# e.unself_out_tb().ClassName #%%>.<%%# e.unself_out_tb().getsecfieldname() #%%>);
                tmpNode.Value = TreeNodeOBj.setRTUNodeO(false, <%%# e.unself_out_tb().ClassName #%%>.<%%# e.unself_out_tb().getfirfieldname() #%%>);
        ...
        {
            tree<%%# e.unself_out_tb().ClassName #%%>.Nodes.Clear();
            TreeNode rootNode = new TreeNode("<%%# e.unself_out_tb().EntityName #%%>");
            rootNode.Value = TreeNodeOBj.setRTUNodeO(true, "0");
            tree<%%# e.unself_out_tb().ClassName #%%>.Nodes.Add(rootNode);

            string rootId = "0";
            List<<%%# e.unself_out_tb().ClassName #%%>Info> <%%# e.unself_out_tb().ClassName #%%>s = getBy<%%# e.unself_out_tb().ClassName.ToParscal() #%%><%%# e.unself_out_tb().self_uni_in_name().ToParscal() #%%>(rootId);
            AddTrees(rootNode, <%%# e.unself_out_tb().ClassName #%%>s);
            rootNode.ExpandAll();
        }

        public void RefreshNode()
        {
			TreeNode tr = tree<%%# e.unself_out_tb().ClassName #%%>.SelectedNode;
			if(tr != null){				
				TreeNodeOBj obj = TreeNodeOBj.getDeliNodeO(tree<%%# e.unself_out_tb().ClassName #%%>.SelectedNode.Value);
				tr.ChildNodes.Clear();
				List<<%%# e.unself_out_tb().ClassName #%%>Info> <%%# e.unself_out_tb().ClassName #%%>s = getBy<%%# e.unself_out_tb().ClassName.ToParscal() #%%><%%# e.unself_out_tb().self_uni_in_name().ToParscal() #%%>(obj.obj.ToString());
				AddTrees(tr, <%%# e.unself_out_tb().ClassName #%%>s);
			}else{
                InitTree();
            }
        }

        protected void tree<%%# e.unself_out_tb().ClassName #%%>_SelectedNodeChanged(object sender, EventArgs e)
        {
            TreeNodeOBj obj = TreeNodeOBj.getDeliNodeO(tree<%%# e.unself_out_tb().ClassName #%%>.SelectedNode.Value);
            if (obj != null)
            {
                ...
                if (!obj.Loaded)
                {
                    List<<%%# e.unself_out_tb().ClassName #%%>Info> <%%# e.unself_out_tb().ClassName #%%>s = getBy<%%# e.unself_out_tb().ClassName.ToParscal() #%%><%%# e.unself_out_tb().self_uni_in_name().ToParscal() #%%>(<%%# e.unself_out_field_name() #%%>);
                    AddTrees(tree<%%# e.unself_out_tb().ClassName #%%>.SelectedNode, <%%# e.unself_out_tb().ClassName #%%>s);
                    tree<%%# e.unself_out_tb().ClassName #%%>.SelectedNode.Value = TreeNodeOBj.setRTUNodeO(true, <%%# e.unself_out_field_name() #%%>);

                    tree<%%# e.unself_out_tb().ClassName #%%>.SelectedNode.ExpandAll();
                }
            }
        }

        #endregion <%%# e.unself_out_tb().ClassName #%%>树控件
